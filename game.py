...
# reset function: agent should be able to reset game after each play
# implement reward for agent
# take action and compute direction
...
class SnakeGameAI:
    ...
    def _move(self, action):
        ...
        if np.array_equal(action, [1, 0, 0]):
            ...
            next_idx = (idx + 1) % 4  # Clockwise turn
            new_dir = clock_wise[next_idx]  # Right turn r -> d -> l -> u
        else:
            next_idx = (idx - 1) % 4  # Counter-clockwise turn
